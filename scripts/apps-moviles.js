// ========================================
// SCRIPT PARA PÁGINA APPS MÓVILES
// ========================================
...
function initScrollAnimations() {
    ...
    const animateElements = document.querySelectorAll(
        '.feature-card, .sector-card, .process-step, .tech-category, .use-case-card'
    );
...
function initPhoneAnimations() {
    ...
    phoneMockups.forEach((phone, index) => {
        ...
        phone.style.transform = 'translateY(50px) rotate(-5deg)';
        
        setTimeout(() => {
            phone.style.transition = 'all 1s ease';
            phone.style.opacity = '1';
            phone.style.transform = 'translateY(0) rotate(-5deg)';
        }, 1000 + (index * 300));
        ...
        window.addEventListener('scroll', () => {
            ...
            phone.style.transform = `translateY(${rate}px) rotate(${rotation}deg)`;
        });
    });
    
    // Animación de la interfaz de la app
    const appInterfaces = document.querySelectorAll('.app-interface');
    
    appInterfaces.forEach((interface, index) => {
        setTimeout(() => {
            interface.style.animation = 'appGlow 3s ease-in-out infinite';
        }, 2000 + (index * 500));
    });
}
